...
export default function Client({ users, category, token }) {
    ...
    const handleEditClick = async () => {
        ...
        const res = await api.put('/client', user)
        if(res.status === 200){
            router.push({
                pathname: '/clients',
                query: {
                    ...
                    <Form.Group>
                        <Row>
                            ...
                            <Col>
                                ...
                                <Form.Control className={styles.formControl} type='text' id='cellphone' defaultValue={users.cellphone} />
                            </Col>
                            <Col>
