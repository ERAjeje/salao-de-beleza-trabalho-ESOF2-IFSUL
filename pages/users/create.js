                        ...
                        <Form.Group>
                            <Row>
                                <Col>
                                    ...
                                    <Form.Control className={styles.formControl} type='text' id='cpf' />
                                </Col>
                                <Col>
                                    <Form.Label>Nome</Form.Label>
                                    <Form.Control className={styles.formControl} type='text' id='name' />
                                </Col>
                            </Row>
                        </Form.Group>
                        <Form.Group>
                            <Row>
                                <Col>
                                    ...
                                    <Form.Control className={styles.formControl} type='text' id='email' />
                                </Col>
                                <Col>
